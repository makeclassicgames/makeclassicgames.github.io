...
* [Libros ensamblador 6502 - Home Vic Software](https://amzn.to/4ifXrVu){:target="blank" title="Libros acerca de programación en ensamblador 6502 y Commodore 64"}
* [Classic Game Programming on the NES: Make your own retro video game - Tony Cruise (English)](https://amzn.to/4iv1dex){:target="blank" title="Libro acerca de programación para NES"}.
* [Desarrollo Moderno de juegos en MSX BASIC: Construye juegos retro con MSX BASIC usando herramientas modernas - Raúl Portales](https://amzn.to/3EZ9E3h){:target="blank" title="Libro acerca de programación en BASIC para MSX."}
