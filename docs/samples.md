...
* NES
    ...
    * [wedNESday 1: Introducción a NES](pdfs/WedNESDay.pdf){:target="blank" title="Presentación Sesión wedNESday 1: Introducción a NES"}.
* Sega Master System
...
* Game Boy:
    ...
    * [Taller GBStudio Euskal Encounter 34](https://makeclassicgames.dev/tallergbstudio/){:target="blank" title="Taller de GBStudio realizado en la Euskal Encounter 34"}.
* Atari Lynx:
...
* Prácticas
    * [Practica 1: Shotemup e Instalación de Raylib](pdfs/P1.pdf){:target="blank" title="Presentación de la práctica 1: Shotemup e Instalación de Raylib"}
* Durango
